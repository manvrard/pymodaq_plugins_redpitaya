...
class DAQ_1DViewer_MockSinus(DAQ_Viewer_base):
    ...
    * PyMoDAQ >= 4.1.0
    ...
    params = comon_parameters+[
        {'title': 'frequency', 'name': 'frequency', 'type': 'float', 'value': 1000, 'suffix': 'Hz', 'siPrefix': True}
        ]
    ...
    def grab_data(self, Naverage=1, **kwargs):
        ...
        data_list = self.controller.snap()
